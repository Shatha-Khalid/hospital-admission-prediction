###############################################################################
# Script Name : logistic_regression_arimax_adasyn.R
# Description : Integrates ARIMAX forecasts with Logistic Regression model 
...
cat("AUC =", auc(roc_obj), "\n")
plot(roc_obj, main = "ROC Curve - Logistic Regression + ARIMAX (ADASYN)", col = "darkgreen")
