###############################################################################
# Script Name: xgboost_classification_smote.R
# Description: 
#   - Train and evaluate XGBoost classifier on SMOTE-balanced data 
...
cat("AUC =", auc(roc_obj), "\n")
plot(roc_obj, main = "ROC Curve - XGBoost (SMOTE)", col = "darkgreen")
