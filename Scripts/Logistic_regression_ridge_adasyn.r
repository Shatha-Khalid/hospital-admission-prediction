###############################################################################
# Script Name: logistic_regression_ridge_adasyn.R
# Description: 
#   - Train and evaluate Logistic Regression (Ridge) on ADASYN-balanced data 
...
cat("AUC =", auc(roc_obj), "\n")
plot(roc_obj, main = "ROC Curve - Logistic Regression (Ridge) - ADASYN", col = "darkred")
