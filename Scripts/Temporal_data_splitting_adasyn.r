###############################################################################
# Script Name: temporal_data_splitting_adasyn.R
# Description: 
#   - Temporal splitting of data after applying ADASYN balancing.
...
BASE_DIR <- getwd()
input_path <- file.path(BASE_DIR, "outputs", "adasyn_balancing_preprocessing.csv")
output_dir <- file.path(BASE_DIR, "outputs", "temporal_splitting_adasyn")
