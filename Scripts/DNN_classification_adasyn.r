###############################################################################
# Script Name: dnn_classification_adasyn.R
# Description: 
#   - Train and evaluate a Deep Neural Network on ADASYN-balanced data 
...
cat("AUC =", auc(roc_obj), "\n")
plot(roc_obj, main = "ROC Curve - DNN (ADASYN)", col = "darkred")
